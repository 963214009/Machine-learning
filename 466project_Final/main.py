...
if __name__ == '__main__':
    ...
    classalgs = {
                 'Linear Support Vector': algs.LinearSVC(),
                 'Gaussian Naive Bayes': algs.Gaussian_NB(),
                 'Logistic Regression': algs.logit(),
    ...
    for learnername, learner in classalgs.items():
        ...
        print('Average error for ' + learnername + ': ' + str(besterror) + ' +- ' + str(
            np.std(errors[learnername][bestparams, :]) / math.sqrt(numruns)))
